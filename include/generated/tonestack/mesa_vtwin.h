namespace tonestack_mesa_vtwin {
...
class module : public dsp {
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		double fSlow3 = (fConst0 * (fSlow2 + 0.0021145000000000001));
		double fSlow4 = (3.0937500000000006e-07 * fSlow0);
		double fSlow5 = ((((((1.2375000000000003e-05 * fSlow1) + -3.492500000000003e-08) - fSlow4) * fSlow0) + (1.8898000000000001e-05 * fSlow1)) + 6.1765000000000013e-07);
		double fSlow6 = ((1.4096500000000004e-09 * fSlow1) - (3.524125000000001e-11 * fSlow0));
		double fSlow7 = (1.5972000000000004e-09 * fSlow1);
		double fSlow8 = ((((fSlow6 + -4.688750000000001e-12) * fSlow0) + fSlow7) + 3.9930000000000011e-11);
		double fSlow9 = (fConst0 * fSlow8);
		double fSlow10 = (1.0 / (-1.0 - (fSlow3 + (fConst1 * (fSlow5 + fSlow9)))));
		double fSlow11 = double(fVslider2);
		double fSlow12 = (fConst0 * ((fSlow2 + (0.0001 * fSlow11)) + 0.00056250000000000007));
		double fSlow13 = (((1.4520000000000003e-07 * fSlow11) + (((3.6437500000000011e-07 - fSlow4) * fSlow0) + (fSlow1 * ((1.2375000000000003e-05 * fSlow0) + 2.9260000000000004e-06)))) + 7.3150000000000016e-08);
		double fSlow14 = (((fSlow6 + 3.524125000000001e-11) * fSlow0) + ((fSlow7 - (3.9930000000000011e-11 * (fSlow0 + -1.0))) * fSlow11));
