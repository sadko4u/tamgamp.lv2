namespace gxsim_pre_12ax7_master_6v6 {
...
class module : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "pre_12ax7_master_6v6");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec15[0] = (double(Ftube(int(TUBE_TABLE_12AX7_68k), double((((0.92544984225177063 * (fRec16[0] + fRec16[2])) + (fRec20[0] + (1.8508996845035413 * fRec16[1]))) + -1.581656)))) + -191.42014814814814);
			fRec14[0] = ((0.025000000000000001 * ((fConst4 * fRec15[0]) + (fConst11 * fRec15[1]))) - (fConst12 * fRec14[1]));
			...
			fRec10[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double((((0.92544984225177063 * (fRec11[0] + fRec11[2])) + (fRec21[0] + (1.8508996845035413 * fRec11[1]))) + -1.204285)))) + -169.71433333333334);
			fRec9[0] = ((0.025000000000000001 * ((fConst4 * fRec10[0]) + (fConst11 * fRec10[1]))) - (fConst12 * fRec9[1]));
			...
			fRec6[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double((((0.92544984225177063 * (fRec7[0] + fRec7[2])) + (fRec22[0] + (1.8508996845035413 * fRec7[1]))) + -0.84070299999999998)))) + -147.47524390243905);
			fRec5[0] = ((0.025000000000000001 * ((fConst4 * fRec6[0]) + (fConst11 * fRec6[1]))) - (fConst12 * fRec5[1]));
