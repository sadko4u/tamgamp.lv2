namespace gxsim_pre_12ax7_pp_6v6 {
...
class module : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "pre_12ax7_pp_6v6");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec21[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double((((0.92544984225177063 * (fRec22[0] + fRec22[2])) + (fRec24[0] + (1.8508996845035413 * fRec22[1]))) + -0.84070299999999998)))) + -147.47524390243905);
			...
			fRec32[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double((((0.92544984225177063 * (fRec33[0] + fRec33[2])) + (fRec35[0] + (1.8508996845035413 * fRec33[1]))) + -1.204285)))) + -169.71433333333334);
			...
			fRec37[0] = (double(Ftube(int(TUBE_TABLE_12AX7_68k), double((((0.92544984225177063 * (fRec38[0] + fRec38[2])) + (fRec46[0] + (1.8508996845035413 * fRec38[1]))) + -1.581656)))) + -191.42014814814814);
			...
			fRec26[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double((((0.92544984225177063 * (fRec27[0] + fRec27[2])) + (fRec47[0] + (1.8508996845035413 * fRec27[1]))) + -1.204285)))) + -169.71433333333334);
			...
			fRec16[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double((((0.92544984225177063 * (fRec17[0] + fRec17[2])) + (fRec48[0] + (1.8508996845035413 * fRec17[1]))) + -0.84070299999999998)))) + -147.47524390243905);
