...
class module : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("12ax7");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec13[0] = (double(Ftube(int(TUBE_TABLE_12AX7_68k), double((((0.92544984225177063 * (fRec14[0] + fRec14[2])) + (fRec35[0] + (1.8508996845035413 * fRec14[1]))) + -1.581656)))) + -191.42014814814814);
			...
			fRec8[0] = (double(Ftube(int(TUBE_TABLE_12AX7_250k), double((((0.92544984225177063 * (fRec9[0] + fRec9[2])) + (fRec36[0] + (1.8508996845035413 * fRec9[1]))) + -1.204285)))) + -169.71433333333334);
