 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec13[0] = (double(Ftube(int(TUBE_TABLE_12AU7_68k), double((((0.92544984225177063 * (fRec14[0] + fRec14[2])) + (fRec35[0] + (1.8508996845035413 * fRec14[1]))) + -3.7189619999999999)))) + -112.26066666666668);
			fRec12[0] = ((0.025000000000000001 * ((fConst4 * fRec13[0]) + (fConst26 * fRec13[1]))) - (fConst27 * fRec12[1]));
			double fTemp14 = (fRec12[0] * fRec5[0]);
			fVec5[0] = fTemp14;
			fRec11[0] = (fConst6 * ((2.0 * (fTemp14 + fVec5[1])) - (fConst7 * fRec11[1])));
			...
			fRec8[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec9[0] + fRec9[2])) + (fRec36[0] + (1.8508996845035413 * fRec9[1]))) + -2.3148439999999999)))) + -95.677066666666661);
