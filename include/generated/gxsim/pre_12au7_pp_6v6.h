namespace gxsim_pre_12au7_pp_6v6 {
...
class module : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "pre_12au7_pp_6v6");
	...
	virtual void instanceConstants(int samplingFreq) {
		...
		fConst19 = (1.8605695850647828 / fConst18);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec21[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec22[0] + fRec22[2])) + (fRec24[0] + (1.8508996845035413 * fRec22[1]))) + -0.44548700000000002)))) + -75.672317073170731);
			fRec20[0] = ((0.10000000000000001 * ((fConst4 * fRec21[0]) + (fConst11 * fRec21[1]))) - (fConst12 * fRec20[1]));
			...
			fRec32[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec33[0] + fRec33[2])) + (fRec35[0] + (1.8508996845035413 * fRec33[1]))) + -0.77616200000000002)))) + -78.255866666666662);
			fRec31[0] = ((0.10000000000000001 * ((fConst4 * fRec32[0]) + (fConst11 * fRec32[1]))) - (fConst12 * fRec31[1]));
			...
			fRec37[0] = (double(Ftube(int(TUBE_TABLE_12AU7_68k), double((((0.92544984225177063 * (fRec38[0] + fRec38[2])) + (fRec46[0] + (1.8508996845035413 * fRec38[1]))) + -1.2572399999999999)))) + -83.435555555555567);
			fRec36[0] = ((0.10000000000000001 * ((fConst4 * fRec37[0]) + (fConst11 * fRec37[1]))) - (fConst12 * fRec36[1]));
			...
			fRec26[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec27[0] + fRec27[2])) + (fRec47[0] + (1.8508996845035413 * fRec27[1]))) + -0.77616200000000002)))) + -78.255866666666662);
			fRec25[0] = ((0.10000000000000001 * ((fConst4 * fRec26[0]) + (fConst11 * fRec26[1]))) - (fConst12 * fRec25[1]));
			...
			fRec16[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec17[0] + fRec17[2])) + (fRec48[0] + (1.8508996845035413 * fRec17[1]))) + -0.44548700000000002)))) + -75.672317073170731);
			fRec15[0] = ((0.10000000000000001 * ((fConst4 * fRec16[0]) + (fConst11 * fRec16[1]))) - (fConst12 * fRec15[1]));
