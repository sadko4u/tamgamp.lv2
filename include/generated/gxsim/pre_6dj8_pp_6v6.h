namespace gxsim_pre_6dj8_pp_6v6 {
...
class module : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "pre_6dj8_pp_6v6");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec21[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double((((0.92544984225177063 * (fRec22[0] + fRec22[2])) + (fRec24[0] + (1.8508996845035413 * fRec22[1]))) + -0.79704299999999995)))) + -32.799634146341475);
			fRec20[0] = ((0.050000000000000003 * ((fConst4 * fRec21[0]) + (fConst11 * fRec21[1]))) - (fConst12 * fRec20[1]));
			...
			fRec32[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double((((0.92544984225177063 * (fRec33[0] + fRec33[2])) + (fRec35[0] + (1.8508996845035413 * fRec33[1]))) + -1.271609)))) + -45.226066666666668);
			fRec31[0] = ((0.050000000000000003 * ((fConst4 * fRec32[0]) + (fConst11 * fRec32[1]))) - (fConst12 * fRec31[1]));
			...
			fRec37[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_68k), double((((0.92544984225177063 * (fRec38[0] + fRec38[2])) + (fRec46[0] + (1.8508996845035413 * fRec38[1]))) + -1.8639460000000001)))) + -60.964962962962957);
			fRec36[0] = ((0.050000000000000003 * ((fConst4 * fRec37[0]) + (fConst11 * fRec37[1]))) - (fConst12 * fRec36[1]));
			...
			fRec26[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double((((0.92544984225177063 * (fRec27[0] + fRec27[2])) + (fRec47[0] + (1.8508996845035413 * fRec27[1]))) + -1.271609)))) + -45.226066666666668);
			fRec25[0] = ((0.050000000000000003 * ((fConst4 * fRec26[0]) + (fConst11 * fRec26[1]))) - (fConst12 * fRec25[1]));
			...
			fRec16[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double((((0.92544984225177063 * (fRec17[0] + fRec17[2])) + (fRec48[0] + (1.8508996845035413 * fRec17[1]))) + -0.79704299999999995)))) + -32.799634146341475);
			fRec15[0] = ((0.050000000000000003 * ((fConst4 * fRec16[0]) + (fConst11 * fRec16[1]))) - (fConst12 * fRec15[1]));
