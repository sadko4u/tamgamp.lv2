...
class module : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("6V6");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec10[0] = ((0.999 * fRec10[1]) + (0.0010000000000000009 * fRec11[0]));
			fRec17[0] = (fSlow1 + (0.999 * fRec17[1]));
			double fTemp0 = (2.0 * (fRec17[0] + -0.5));
			double fTemp1 = double(input0[i]);
			fRec25[0] = (fTemp1 - (fConst23 * ((fConst24 * fRec25[2]) + (fConst25 * fRec25[1]))));
			double fTemp2 = (fRec25[2] + (fRec25[0] + (2.0 * fRec25[1])));
			fVec0[0] = fTemp2;
			fRec24[0] = ((fConst23 * ((fConst4 * fTemp2) + (fConst26 * fVec0[1]))) - (fConst27 * fRec24[1]));
			fRec23[0] = (0.0 - (fConst19 * ((fConst20 * fRec23[1]) - (fRec24[0] + fRec24[1]))));
			fRec22[0] = (fRec23[0] - (fConst15 * ((fConst28 * fRec22[2]) + (fConst31 * fRec22[1]))));
			double fTemp3 = (fRec22[2] + (fRec22[0] + (2.0 * fRec22[1])));
			fVec1[0] = fTemp3;
			fRec21[0] = ((fConst15 * ((fConst17 * fTemp3) + (fConst32 * fVec1[1]))) - (fConst34 * fRec21[1]));
			fRec20[0] = (fRec21[0] - (fConst10 * ((fConst35 * fRec20[2]) + (fConst36 * fRec20[1]))));
			double fTemp4 = (fConst46 * fRec19[1]);
			fRec19[0] = ((fConst10 * (((fConst12 * fRec20[0]) + (fConst37 * fRec20[1])) + (fConst12 * fRec20[2]))) - (fConst41 * ((fConst43 * fRec19[2]) + fTemp4)));
			double fTemp5 = std::max<double>(-1.0, std::min<double>(1.0, ((fRec19[2] + (fConst41 * (fTemp4 + (fConst43 * fRec19[0])))) * std::pow(10.0, (1.2 * fRec17[0])))));
			fRec29[0] = ((fConst47 * fRec24[1]) - (fConst19 * ((fConst20 * fRec29[1]) - (fConst14 * fRec24[0]))));
			fRec28[0] = (fRec29[0] - (fConst15 * ((fConst28 * fRec28[2]) + (fConst31 * fRec28[1]))));
			double fTemp6 = (fConst36 * fRec27[1]);
			fRec27[0] = ((fConst15 * (((fConst30 * fRec28[0]) + (fConst48 * fRec28[1])) + (fConst30 * fRec28[2]))) - (fConst49 * ((fConst50 * fRec27[2]) + fTemp6)));
			double fTemp7 = (fConst46 * fRec26[1]);
			fRec26[0] = ((fRec27[2] + (fConst49 * (fTemp6 + (fConst50 * fRec27[0])))) - (fConst41 * ((fConst43 * fRec26[2]) + fTemp7)));
			double fTemp8 = std::max<double>(-1.0, std::min<double>(1.0, ((fRec26[2] + (fConst41 * (fTemp7 + (fConst43 * fRec26[0])))) * std::pow(10.0, (0.80000000000000004 * fRec17[0])))));
			fRec33[0] = (0.0 - (fConst53 * ((fConst33 * fRec33[1]) - (fConst15 * (fTemp3 + fVec1[1])))));
			fRec32[0] = (fRec33[0] - (fConst10 * ((fConst35 * fRec32[2]) + (fConst36 * fRec32[1]))));
			double fTemp9 = (fRec32[2] + (fRec32[0] + (2.0 * fRec32[1])));
			fVec2[0] = fTemp9;
			fRec31[0] = ((fConst10 * ((fConst52 * fTemp9) + (fConst54 * fVec2[1]))) - (fConst55 * fRec31[1]));
			fRec30[0] = (fRec31[0] - (fConst51 * ((fConst56 * fRec30[2]) + (fConst46 * fRec30[1]))));
			double fTemp10 = std::max<double>(-1.0, std::min<double>(1.0, (fConst51 * ((((fConst45 * fRec30[0]) + (fConst57 * fRec30[1])) + (fConst45 * fRec30[2])) * std::pow(10.0, (2.0 * fRec17[0]))))));
			fRec35[0] = (0.0 - (fConst58 * ((fConst42 * fRec35[1]) - (fConst10 * (fTemp9 + fVec2[1])))));
			fRec34[0] = (fRec35[0] - (fConst51 * ((fConst56 * fRec34[2]) + (fConst46 * fRec34[1]))));
			double fTemp11 = std::max<double>(-1.0, std::min<double>(1.0, (fConst51 * ((fRec34[2] + (fRec34[0] + (2.0 * fRec34[1]))) * std::pow(10.0, (0.90000000000000002 * fRec17[0]))))));
			...
			fVec3[0] = fTemp12;
			fRec18[0] = (0.0 - (fConst6 * ((fConst7 * fRec18[1]) - (fTemp12 + fVec3[1]))));
			double fTemp13 = (fRec10[0] * (((1.0 - std::max<double>(0.0, fTemp0)) * fTemp1) + (fRec18[0] * (1.0 - std::max<double>(0.0, (-1.0 * fTemp0))))));
			fVec4[0] = fTemp13;
			fRec16[0] = ((0.93028479253239138 * (fTemp13 + fVec4[1])) - (0.86056958506478287 * fRec16[1]));
			fRec15[0] = (fRec16[0] - ((1.8405051250752198 * fRec15[1]) + (0.86129424393186271 * fRec15[2])));
			fRec36[0] = (fConst60 * ((0.027 * (fRec14[1] + fRec14[2])) - (fConst61 * fRec36[1])));
			fRec14[0] = (double(Ftube(int(TUBE_TABLE_6V6_68k), double((((0.92544984225177063 * (fRec15[0] + fRec15[2])) + (fRec36[0] + (1.8508996845035413 * fRec15[1]))) + -2.2961499999999999)))) + -164.9574074074074);
			fRec13[0] = ((0.025000000000000001 * ((fConst4 * fRec14[0]) + (fConst26 * fRec14[1]))) - (fConst27 * fRec13[1]));
			fRec12[0] = (fConst6 * ((0.77000000000000002 * (fRec13[0] + fRec13[1])) - (fConst7 * fRec12[1])));
			double fTemp14 = (fRec10[0] * fRec12[0]);
			fVec5[0] = fTemp14;
			...
			fRec4[0] = (std::pow(10.0, (2.4239999999999999 * (fRec5[0] * (fRec38[0] + -0.01)))) - ((fConst66 * fRec4[1]) + (0.85026841000000009 * fRec4[2])));
			...
			fRec40[0] = ((0.999 * fRec40[1]) + (6.3100000000000057e-05 * fRec41[0]));
			output0[i] = FAUSTFLOAT((0.77000000000000002 * (fRec0[0] * fRec40[0])));
			fRec11[1] = fRec11[0];
			fRec10[1] = fRec10[0];
			fRec17[1] = fRec17[0];
			fRec25[2] = fRec25[1];
