 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec13[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_68k), double((((0.92544984225177063 * (fRec14[0] + fRec14[2])) + (fRec35[0] + (1.8508996845035413 * fRec14[1]))) + -1.8639460000000001)))) + -60.964962962962957);
			fRec12[0] = ((0.050000000000000003 * ((fConst4 * fRec13[0]) + (fConst26 * fRec13[1]))) - (fConst27 * fRec12[1]));
			...
			fRec8[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double((((0.92544984225177063 * (fRec9[0] + fRec9[2])) + (fRec36[0] + (1.8508996845035413 * fRec9[1]))) + -1.271609)))) + -45.226066666666668);
			fRec7[0] = ((0.050000000000000003 * ((fConst4 * fRec8[0]) + (fConst26 * fRec8[1]))) - (fConst27 * fRec7[1]));
			...
			fRec1[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_68k), double(((fTemp16 + (fRec37[0] + fTemp17)) + -0.79903100000000005)))) + -32.55719512195121);
			...
			fRec39[0] = (double(Ftube(int(TUBE_TABLE_6DJ8_250k), double(((fTemp16 + (fRec40[0] + fTemp17)) + -0.79704299999999995)))) + -32.799634146341475);
			fRec38[0] = ((0.050000000000000003 * ((fConst4 * fRec39[0]) + (fConst26 * fRec39[1]))) - (fConst27 * fRec38[1]));
			fRec42[0] = (fSlow2 + (0.999 * fRec42[1]));
			fRec41[0] = ((0.999 * fRec41[1]) + (6.3100000000000057e-05 * fRec42[0]));
			output0[i] = FAUSTFLOAT(((fRec0[0] + fRec38[0]) * fRec41[0]));
			fRec6[1] = fRec6[0];
			fRec5[1] = fRec5[0];
			fRec16[1] = fRec16[0];
			fRec24[2] = fRec24[1];
