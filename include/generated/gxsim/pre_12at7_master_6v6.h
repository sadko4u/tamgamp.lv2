namespace gxsim_pre_12at7_master_6v6 {
...
class module : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "pre_12at7_master_6v6");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec15[0] = (double(Ftube(int(TUBE_TABLE_12AT7_68k), double((((0.92544984225177063 * (fRec16[0] + fRec16[2])) + (fRec20[0] + (1.8508996845035413 * fRec16[1]))) + -2.617753)))) + -153.04618518518518);
			...
			fRec10[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double((((0.92544984225177063 * (fRec11[0] + fRec11[2])) + (fRec21[0] + (1.8508996845035413 * fRec11[1]))) + -1.887332)))) + -124.17786666666666);
			...
			fRec6[0] = (double(Ftube(int(TUBE_TABLE_12AT7_250k), double((((0.92544984225177063 * (fRec7[0] + fRec7[2])) + (fRec22[0] + (1.8508996845035413 * fRec7[1]))) + -1.2569619999999999)))) + -96.711951219512201);
