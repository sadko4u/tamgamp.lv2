namespace gxsim_pre_12au7_master6v6 {
...
class module : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "pre_12au7_master6v6");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec15[0] = (double(Ftube(int(TUBE_TABLE_12AU7_68k), double((((0.92544984225177063 * (fRec16[0] + fRec16[2])) + (fRec20[0] + (1.8508996845035413 * fRec16[1]))) + -1.2572399999999999)))) + -83.435555555555567);
			fRec14[0] = ((0.10000000000000001 * ((fConst4 * fRec15[0]) + (fConst11 * fRec15[1]))) - (fConst12 * fRec14[1]));
			...
			fRec10[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec11[0] + fRec11[2])) + (fRec21[0] + (1.8508996845035413 * fRec11[1]))) + -0.77616200000000002)))) + -78.255866666666662);
			fRec9[0] = ((0.10000000000000001 * ((fConst4 * fRec10[0]) + (fConst11 * fRec10[1]))) - (fConst12 * fRec9[1]));
			...
			fRec6[0] = (double(Ftube(int(TUBE_TABLE_12AU7_250k), double((((0.92544984225177063 * (fRec7[0] + fRec7[2])) + (fRec22[0] + (1.8508996845035413 * fRec7[1]))) + -0.44548700000000002)))) + -75.672317073170731);
			fRec5[0] = ((0.10000000000000001 * ((fConst4 * fRec6[0]) + (fConst11 * fRec6[1]))) - (fConst12 * fRec5[1]));
