...
#ifndef RESOURCES_AMPSIM_H_
#define RESOURCES_AMPSIM_H_

#include <resources/faust.h>

#define AMPSIM_GAIN_NORM_STEPS      32
...
namespace tamgamp_lv2
{
     ...
     */
    extern faust::dsp_factory_t ampsim_dsp[];

    /**
     * Output gain norming coefficients
     */
    extern const float ampsim_norming[];
}

#endif /* RESOURCES_AMPSIM_H_ */
